...
public class Player 
{
   ...
   public void setTeam(Team team) 
   {
    ...
    /**
    * <b>transformer(mutative)</b>: sets the collection(Sullogi) who wants a player to play  to cardsforplaying  <br />
   ...
   /**
    * <b>transformer(mutative)</b>: adds a collection to players mpaza(cards which count for points)  <br />
